...
extern map<Uint16, vector<vector<Uint16>>> _vowelForTN;
extern map<Uint16, vector<vector<Uint32>>> _vowelCombine;
extern map<Uint16, vector<vector<Uint16>>> _vowelForMark;
extern map<Uint16, vector<vector<Uint16>>> _vowelForMarkForTN;
extern vector<vector<Uint16>> _consonantD;
extern vector<vector<Uint16>> _consonantC;
extern vector<vector<Uint16>> _consonantN;
...
extern Uint16 _unicodeCompoundMarkForTN[];
