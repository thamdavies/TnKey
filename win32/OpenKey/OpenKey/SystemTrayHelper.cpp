...
#define POPUP_UNICODE_COMPOUND_TN 935
...
map<UINT, LPCTSTR> menuData = {
	...
	{POPUP_TELEX_TN, _T("Kiểu gõ Telex Tây Nguyên")},
	...
	{POPUP_UNICODE_COMPOUND_TN, _T("Unicode Tây Nguyên")},
	...
	{POPUP_ABOUT_OPENKEY, _T("Giới thiệu TnKey")},
	...
	case WM_TRAYMESSAGE: {
		...
		if (lParam == WM_LBUTTONUP) {
			...
			case POPUP_VN_LOCALE_1258:
				...
				break;
			case POPUP_UNICODE_COMPOUND_TN:
				AppDelegate::getInstance()->onTableCode(5);
				break;
...
void SystemTrayHelper::createPopupMenu() {
	...
	AppendMenu(popupMenu, MF_CHECKED, POPUP_TELEX_TN, menuData[POPUP_TELEX_TN]);
	...
	AppendMenu(popupMenu, MF_UNCHECKED, POPUP_UNICODE_COMPOUND_TN, menuData[POPUP_UNICODE_COMPOUND_TN]);
...
void SystemTrayHelper::updateData() {
	...
	MODIFY_MENU(popupMenu, POPUP_TELEX_TN, vInputType == 3);
	...
	MODIFY_MENU(popupMenu, POPUP_UNICODE_COMPOUND_TN, vCodeTable == 5);
