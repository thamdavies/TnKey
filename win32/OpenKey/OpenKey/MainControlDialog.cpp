...
INT_PTR MainControlDialog::eventProc(HWND hDlg, UINT uMsg, WPARAM wParam, LPARAM lParam) {
	...
	case WM_COMMAND: {
		...
		//case IDC_BUTTON_GO_SOURCE_CODE:
			//ShellExecute(NULL, _T("open"), _T("https://drive.google.com/drive/u/0/folders/1Qh1ikv9erbi_-Ixb5MfA0ObnD5kyeLEd"), NULL, NULL, SW_SHOWNORMAL);
			//break;
		default:
	...
	case WM_NOTIFY: {
		...
		case NM_RETURN: {
			...
			if (link->hdr.idFrom == IDC_SYSLINK_HOME_PAGE)
				...
				ShellExecute(NULL, _T("open"), _T("https://www.facebook.com/OpenKeyTN"), NULL, NULL, SW_SHOWNORMAL);
